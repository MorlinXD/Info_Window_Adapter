...
public class Modelo {
    ...
    public Modelo(JSONObject a) throws JSONException {
    ...
    public static ArrayList<Modelo> JsonObjectsBuild(JSONArray datos) throws JSONException {
        ArrayList<Modelo> places = new ArrayList<>();

        for (int i = 0; i < datos.length() && i<20; i++) {
            places.add(new Modelo(datos.getJSONObject(i)));
        }
        return places;
    }
