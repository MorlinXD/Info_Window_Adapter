package com.example.info_window_adapter;
...
public class MainActivity extends AppCompatActivity
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        mMap.setInfoWindowAdapter(new adaptador(LayoutInflater.from(getApplicationContext())));
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null,
                response -> {
                    try {
                        ...
                        ArrayList<Modelo> lstplace = Modelo.JsonObjectsBuild(results);
